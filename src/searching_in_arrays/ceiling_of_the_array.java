...
//for finding the element which is smallest among elements greater than target element
public class ceiling_of_the_array {
	...
	public static void main(String[] args) {
        ...
        int ans=ceilingOfArray(arr,target);
	...
	static int ceilingOfArray(int[] arr,int target) {
		...
		return arr[S];//rather than returning -1 you have to return Start element when the loop condition is violated, which is the required answer
	}
